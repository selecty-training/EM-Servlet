	...
	<form action="select" method="post" >
		...
		<table>
			<tr>
				...
				<td>
					<input type="text" name="empId" placeholder="社員ID" value="${param.empId }" />
				</td>
			</tr>
			<tr>
				<th class="header">社員名</th>
				<td>
					<input type="text" name="empNm" placeholder="社員名" value="${param.empNm }" />
				</td>
			</tr>
			<tr>
				<th class="header">社員名フリガナ</th>
				<td>
					<input type="text" name="empKn" placeholder="フリガナ" value="${param.empKn }" />
				</td>
			</tr>
			<tr>
				<th class="header">メールアドレス</th>
				<td>
					<input type="text" name="mail" placeholder="メールアドレス" value="${param.mail }" />
				</td>
			</tr>
			<tr>
